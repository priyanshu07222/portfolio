...
export function SiteHeader() {
  return (
    <>
      ...
      <div className="fixed bottom-[calc(--spacing(2)+env(safe-area-inset-bottom,0px))] left-1/2 z-50 flex w-fit -translate-x-1/2 items-center rounded-xl bg-popover px-2.5 py-1 shadow-md ring ring-foreground/10 sm:hidden dark:ring-foreground/20">
