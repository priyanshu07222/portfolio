...
import { SITE_INFO, SOURCE_CODE_GITHUB_URL, X_USERNAME } from "@/config/site"
    ...
    <footer className="max-w-screen overflow-x-hidden px-2">
      <div className="screen-line-top mx-auto border-x border-line pt-4 group-has-data-[slot=layout-wide]/layout:container md:max-w-3xl">
        <p className="mb-1 px-4 text-center font-mono text-sm text-balance text-muted-foreground">
          UI adapted from the open-source{" "}
          <a
        ...
        <p className="mb-4 px-4 text-center font-mono text-sm text-balance text-muted-foreground">
          © {new Date().getFullYear()} {SITE_INFO.name}. Source on{" "}
          <a
            className="link transition-[color] hover:text-foreground"
        ...
        <div className="screen-line-top screen-line-bottom flex w-full before:z-1 after:z-1">
          <div className="mx-auto flex items-center justify-center gap-3 border-x border-line bg-background px-4">
            ...
            <a
              ...
              href={`https://x.com/${X_USERNAME.replace("@", "")}`}
              target="_blank"
              rel="noopener"
            >
            ...
            <a
              className="flex items-center text-muted-foreground transition-[color] hover:text-foreground"
              href="https://github.com/priyanshudotsol"
              target="_blank"
              rel="noopener"
            >
